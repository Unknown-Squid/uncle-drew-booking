...
import Reservation from "../../Components/BookingForms/Reservation";
import BookingDetails from "../../Components/BookingForms/BookingDetails";
import Payment from "../../Components/BookingForms/Payment";

import Swal from 'sweetalert2';
import { GetBookingByKey } from "../../apiClient/BookingData";
import FeedBackModal from "../../Components/Modal/FeedBackModal";
import ReferenceNumberModal from "@/app/Components/Modal/ReferenceNumberModal";
...
export default function BookingForm() {
  ...
  const handleBookingSetup = (setup) => {
    ...
    setupOptions.map(item => {
        if (item.label == setup){
            ...
            setTotalComputation(0);
            setWithLightComputation(0);
            setWithoutLightComputation(0);
            setWithLightDuration(0);
            setWithoutLightDuration(0);
        }
    })
  };
  ...
  useEffect(() => {
    if (startIdx && endIdx){
      if (startIdx <= 6 && endIdx > 6 && bookingSetup == "Without Lights"){
  ...
  return (
    ...
    >
        ...
        >
            ...
            <div className="flex flex-col justify-center items-center w-full h-fit bg-[var(--page-bg)] gap-10">
                ...
                <Payment
                    ...
                    isReferenceNumber={isReferenceNumber}
                    setIsReferenceNumber={setIsReferenceNumber}
      ...
      <ReferenceNumberModal
        isShow={isReferenceNumber}
        cancelModal={() => setIsReferenceNumber(false)}
        referenceNumber={referenceNumber}
