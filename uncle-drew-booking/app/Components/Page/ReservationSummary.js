...
const ReservationSummary = ({ 
  ...
  return (
    <div className={`xl:w-[30%] w-[80%] h-screen bg-white rounded-[10px] px-6 py-4 mt-20 ${isShow ? "flex" : "hidden"} flex-col`}>

        <h2 className="text-[var(--text-dark-blue)] text-[30px] border-b border-[var(--border-gray)] mt-5">Reservation Summary</h2>
